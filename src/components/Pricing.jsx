    ...
    <section id="pricing" className="py-20 bg-[#FAF8F5] relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 items-stretch">
          {/* Price 1 */}
          <div className="bg-white border border-stone-200 rounded-3xl p-8 shadow-md flex flex-col justify-between text-left">
          ...
          {/* Price 2 - Highlighted */}
          <div className="bg-white border-2 border-orange-600 rounded-3xl p-8 shadow-xl flex flex-col justify-between text-left relative transform scale-102">
            <div className="absolute top-0 right-8 -translate-y-1/2 bg-orange-600 text-white text-[10px] font-extrabold px-3 py-1 rounded-full uppercase tracking-wider">
              Most Booked
            </div>
            <div className="space-y-6">
              <div>
