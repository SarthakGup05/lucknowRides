    ...
    <section id="services" className="py-20 bg-white relative">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {/* Card 1 */}
          <div className="bg-[#FAF8F5]/80 border border-stone-200/80 p-8 rounded-2xl hover:border-orange-500/30 hover:shadow-xl hover:shadow-orange-500/5 transition-all group text-left relative overflow-hidden">
